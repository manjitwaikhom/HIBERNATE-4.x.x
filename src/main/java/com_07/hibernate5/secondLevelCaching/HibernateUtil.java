...
/*import static org.hibernate.cfg.AvailableSettings.CACHE_PROVIDER_CONFIG;
	...
	public static SessionFactory getSessionFactory() {
		...
		if (sessionFactory == null) {
			try {
				...
				settings.setProperty(AvailableSettings.CACHE_REGION_FACTORY,"org.hibernate.cache.ehcache.EhCacheRegionFactory");
